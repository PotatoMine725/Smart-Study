...
- `docs/plans/2026-08-19-e6-cascade-coverage-test.md` (archived 2026-09-18 → `legacy/Archived plans/`, local-only; recoverable from git history) and [`docs/reports/2026-08-20-e6-cascade-coverage-test.md`](../reports/2026-08-20-e6-cascade-coverage-test.md) — the E6 follow-up end to end: the design that set the acceptance bar and its fallback in advance, and the campaign that missed the bar and said so.
