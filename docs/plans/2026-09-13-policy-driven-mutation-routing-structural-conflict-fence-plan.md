...
- The **compound-save** consequence: one blocked intent rejects the whole semester save, including
  ...
  persisted state, the rejection is surfaced, and nothing is retried automatically. That restoration is what
