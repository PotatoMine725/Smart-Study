...
| Work | Plan | State |
|---|---|---|
| **Edge AI — neural encoder for the Smart Parser (M8-A)** | **Execution:** [`../plans/2026-08-24-edge-ai-neural-encoder-execution-plan.md`](../plans/2026-08-24-edge-ai-neural-encoder-execution-plan.md) · **Contract:** [`../specs/2026-08-24-neural-encoder-smart-parser.md`](../specs/2026-08-24-neural-encoder-smart-parser.md) · **Why:** [`../plans/2026-08-24-edge-ai-encoder-adoption.md`](../plans/2026-08-24-edge-ai-encoder-adoption.md) | **ACTIVE — S0 in progress (2026-08-25).** S-SPEC–S3 scope-frozen and activated 2026-08-24. **S-SPEC executed** (`d141db1`): `ML_Heuristic_design.md` gains §9.1 (narrow frozen-encoder exception, eight guardrails) and §10 "Unit of the cap" (artifacts, not heads), under PD-1/PD-2. The specification was **ratified 2026-08-24** together with **PD-12** (the 500 ms latency ceiling). **S0 is the offline pilot** — a hard gate with a kill criterion stated in advance; **a null result ends the plan and is a valid, complete outcome** (PD-3). Its report lands at [`../reports/2026-08-25-encoder-pilot.md`](../reports/2026-08-25-encoder-pilot.md) and is decided at **CP1**; **no production code exists before that acceptance** (EVA-01). S4 left open by design (PD-11: delivery mechanism + size cap decided there, from S0's measurements); S5–S6 not activated, each needs its own owner approval. Owner decisions: [`../plans/2026-08-24-edge-ai-encoder-owner-decision-handoff.md`](../plans/2026-08-24-edge-ai-encoder-owner-decision-handoff.md) |
